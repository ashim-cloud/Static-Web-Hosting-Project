...
# Make Enable Pipeline true to create CodePipeline after Prod is Created, set to false to skip pipeline creation and only create other resources like S3, IAM, etc.
