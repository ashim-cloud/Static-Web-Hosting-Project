...
variable "test_lambda_function_name" {
  description = "Lambda function name used by Test stage to validate index.html before cache invalidation."
  type        = string
}

variable "test_lambda_function_arn" {
  description = "Lambda function ARN used by Test stage invoke permission."
  type        = string
}
